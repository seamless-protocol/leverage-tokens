...
transfer-roles-tenderly :; forge script script/1/TransferAdminAndFeeManagerRoles.s.sol:TransferAdminAndFeeManagerRoles --force --rpc-url tenderly --account ${DEPLOYER_ACCOUNT_NAME} --sender ${DEPLOYER_ACCOUNT_ADDRESS} --slow --broadcast -vvvv
...
transfer-roles-ethereum :; forge script script/1/TransferAdminAndFeeManagerRoles.s.sol:TransferAdminAndFeeManagerRoles --force --rpc-url eth --account ${DEPLOYER_ACCOUNT_NAME} --sender ${DEPLOYER_ACCOUNT_ADDRESS} --slow --broadcast -vvvv
