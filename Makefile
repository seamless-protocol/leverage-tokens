...
deploy-leverage-token-deployment-batcher-ethereum	:; forge script script/1/DeployLeverageTokenDeploymentBatcher.s.sol:DeployLeverageTokenDeploymentBatcher --force --rpc-url eth --account ${DEPLOYER_ACCOUNT_NAME} --sender ${DEPLOYER_ACCOUNT_ADDRESS} --slow --broadcast -vvvv --verify --verifier-url ${ETH_VERIFIER_URL} --etherscan-api-key ${ETH_VERIFIER_KEY}
...
deploy-leverage-token-deployment-batcher-base	:; forge script script/8453/DeployLeverageTokenDeploymentBatcher.s.sol:DeployLeverageTokenDeploymentBatcher --force --rpc-url base --account ${DEPLOYER_ACCOUNT_NAME} --sender ${DEPLOYER_ACCOUNT_ADDRESS} --slow --broadcast -vvvv --verify --verifier-url ${BASE_VERIFIER_URL} --etherscan-api-key ${BASE_VERIFIER_KEY}
