...
contract CreateLeverageToken is Script {
    ...
    ILeverageTokenDeploymentBatcherCow public leverageTokenDeploymentBatcherCow =
        ILeverageTokenDeploymentBatcherCow(DeployConstants.LEVERAGE_TOKEN_DEPLOYMENT_BATCHER_COW);
    ...
    address public COW_TRAMPOLINE = 0x60Bf78233f48eC42eE3F101b9a05eC7878728006;
    ...
    function run() public {
        ...
        ILeverageTokenDeploymentBatcherCow.MorphoLendingAdapterDeploymentParams memory lendingAdapterDeploymentParams =
            ILeverageTokenDeploymentBatcherCow.MorphoLendingAdapterDeploymentParams({
        ...
        ILeverageTokenDeploymentBatcherCow.RebalanceAdapterDeploymentParams memory rebalanceAdapterDeploymentParams =
            ILeverageTokenDeploymentBatcherCow.RebalanceAdapterDeploymentParams({
                ...
                cowTrampoline: COW_TRAMPOLINE
            });

        IERC20(COLLATERAL_TOKEN_ADDRESS).approve(address(leverageTokenDeploymentBatcherCow), INITIAL_COLLATERAL_DEPOSIT);
        (ILeverageToken leverageToken, ActionData memory depositData) = leverageTokenDeploymentBatcherCow.deployLeverageTokenAndDeposit(
