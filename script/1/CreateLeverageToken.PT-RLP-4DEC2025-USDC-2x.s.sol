...
contract CreateLeverageToken is Script {
    ...
    Id public MORPHO_MARKET_ID = Id.wrap(0xa02ad0cf521ba5e5b20d1bcb98043eb091807e2b3bf26df5aad1ad154a3b8d45);
    ...
    /// @dev Name of the LT
    string public LT_NAME = "PT-RLP-4DEC2025 / USDC 2x Leverage Token";
    /// @dev Symbol of the LT
    string public LT_SYMBOL = "PT-RLP-4DEC2025-USDC-2x";

    /// @dev Initial collateral deposit for the LT
    uint256 public INITIAL_COLLATERAL_DEPOSIT = 2e6;
    uint256 public INITIAL_COLLATERAL_DEPOSIT_MIN_SHARES = 1e18;

    address public COLLATERAL_TOKEN_ADDRESS = 0x3A70F0C696dcB3A4aB3833cD9726397dD61AC85e;
    address public DEBT_TOKEN_ADDRESS = 0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48;
    string public COLLATERAL_TOKEN_NAME = "PT Resolv Liquidity Provider Token 4DEC2025";
    string public COLLATERAL_TOKEN_SYMBOL = "PT-RLP-4DEC2025";
