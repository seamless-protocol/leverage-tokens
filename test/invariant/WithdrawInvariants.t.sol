...
contract WithdrawInvariants is InvariantTestBase {
    function invariant_withdraw() public view {
        ...
        LeverageTokenState memory stateAfter = leverageManager.getLeverageTokenState(withdrawData.leverageToken);
    ...
    function _assertCollateralRatioInvariants(
        ...
        uint256 totalSupplyAfter = withdrawData.leverageToken.totalSupply();
