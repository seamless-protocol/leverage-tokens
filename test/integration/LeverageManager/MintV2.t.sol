...
contract LeverageManagerMintTest is LeverageManagerTest {
    ...
    function testFork_mint_NoFee() public {
        ...
        _mintV2(user, sharesToMint, collateralToAdd);
    ...
    function testFork_mint_WithFees() public {
        ...
        previewData = leverageManager.previewMintV2(leverageToken, sharesToMint);
        ...
        // Mint again
        _mintV2(user, sharesToMint, previewData.collateral);
