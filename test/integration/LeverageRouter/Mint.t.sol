...
contract LeverageRouterMintTest is LeverageRouterTest {
    /// @dev In this block price on oracle 3392.292471591441746049801068
    function testFork_mint_UniswapV2() public {
    ...
    /// @dev In this block price on oracle 3392.292471591441746049801068
    function testFork_mint_UniswapV3() public {
        uint256 equityInCollateralAsset = 1 ether;
        uint256 collateralToAdd = 2 * equityInCollateralAsset;
        uint256 userBalanceOfCollateralAsset = 4 ether; // User has more than enough assets for the mint of equity
    ...
    /// @dev In this block price on oracle 3392.292471591441746049801068
    function testFork_mint_Aerodrome() public {
        uint256 equityInCollateralAsset = 1 ether;
        uint256 collateralToAdd = 2 * equityInCollateralAsset;
        uint256 userBalanceOfCollateralAsset = 4 ether; // User has more than enough assets for the mint of equity
    ...
    /// @dev In this block price on oracle 3392.292471591441746049801068
    function testFork_mint_AerodromeSlipstream() public {
        uint256 equityInCollateralAsset = 1 ether;
        uint256 collateralToAdd = 2 * equityInCollateralAsset;
        uint256 userBalanceOfCollateralAsset = 4 ether; // User has more than enough assets for the mint of equity
        ...
        _dealAndMint(WETH, USDC, userBalanceOfCollateralAsset, equityInCollateralAsset, 0, swapContext);

        // Initial mint results in 1:1 shares to equity
        assertEq(leverageToken.balanceOf(user), equityInCollateralAsset);
        // Collateral is taken from the user for the mint and the user receives surplus collateral
        assertEq(
            WETH.balanceOf(user),
    ...
    function testFork_mint_UniswapV2_MultiHop() public {
        uint256 equityInCollateralAsset = 1 ether;
        uint256 collateralToAdd = 2 * equityInCollateralAsset;
        uint256 userBalanceOfCollateralAsset = 4 ether; // User has more than enough assets for the mint of equity
    ...
    function testFork_mint_UniswapV3_MultiHop() public {
        uint256 equityInCollateralAsset = 1 ether;
        uint256 collateralToAdd = 2 * equityInCollateralAsset;
        uint256 userBalanceOfCollateralAsset = 4 ether; // User has more than enough assets for the mint of equity
    ...
    function testFork_mint_Aerodrome_MultiHop() public {
        uint256 equityInCollateralAsset = 1 ether;
        uint256 collateralToAdd = 2 * equityInCollateralAsset;
        uint256 userBalanceOfCollateralAsset = 4 ether; // User has more than enough assets for the mint of equity
    ...
    function testFork_mint_AerodromeSlipstream_MultiHop() public {
        uint256 equityInCollateralAsset = 1 ether;
        uint256 collateralToAdd = 2 * equityInCollateralAsset;
        uint256 userBalanceOfCollateralAsset = 4 ether; // User has more than enough assets for the mint of equity
    ...
    function testFork_mint_RevertIf_InsufficientSenderCollateralAssetsForEquity() public {
        uint256 equityInCollateralAsset = 1 ether;
        uint256 userBalanceOfCollateralAsset = equityInCollateralAsset - 1; // User does not have enough assets for the mint of equity
        ...
        leverageRouter.mint(leverageToken, equityInCollateralAsset, 0, 0, swapContext);
        vm.stopPrank();
    }

    function testFork_mint_RevertIf_InsufficientSenderCollateralAssetsForMaxSwapCost() public {
        uint256 equityInCollateralAsset = 1 ether;
