...
contract MintTest is EtherFiLeverageRouterTest {
    function testFuzz_Mint(
        ...
        collateralToken.approve(address(etherFiLeverageRouter), equityInCollateralAsset + maxSwapCostInCollateralAsset);
        etherFiLeverageRouter.mint(leverageToken, equityInCollateralAsset, shares, maxSwapCostInCollateralAsset);
    ...
    function test_Mint_WithSurplusFromEtherFiLiquidityPool() public {
        ...
        etherFiLeverageRouter.mint(leverageToken, equityInCollateralAsset, shares, 0);
    ...
    function test_Mint_WithDeficitFromEtherFiLiquidityPool() public {
        uint256 requiredCollateral = 100e18;
        uint256 equityInCollateralAsset = 50e18;
        uint256 requiredFlashLoan = requiredCollateral - equityInCollateralAsset;
        ...
        etherFiL2ModeSyncPool.mockSetAmountOut(requiredFlashLoan - maxSwapCostInCollateralAsset); // Deficit of 1 wei of weETH
        ...
        // The sender used all of their assets for the mint
