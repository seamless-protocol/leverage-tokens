...
contract SwapExactFromToMinToAerodromeV2Test is SwapAdapterBaseTest {
    ...
    function testFuzz_SwapExactFromToMinToAerodrome(uint256 fromAmount, uint256 minToAmount) public {
        ...
        uint256 toAmount =
            swapAdapter.exposed_swapExactFromToMinToAerodrome(fromToken, toToken, fromAmount, minToAmount, swapContext);
