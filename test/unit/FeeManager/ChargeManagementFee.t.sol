...
contract ChargeManagementFeeTest is FeeManagerTest {
    ...
    function test_chargeManagementFee_TreasuryNotSet() public {
        ...
        // 10% of 1000 total supply should be accrued but not minted to the treasury and the last management fee accrual timestamp
        ...
        // Set the treasury and charge the management fee again
