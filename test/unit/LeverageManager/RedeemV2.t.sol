...
contract RedeemTest is LeverageManagerTest {
    ...
    function testFuzz_redeem(
        ...
        uint256 expectedCollateral = leverageManager.previewRedeemV2(leverageToken, sharesToRedeem).collateral;
    ...
    function _testRedeem(uint256 sharesToRedeem, uint256 minCollateral) internal {
        ...
        ActionDataV2 memory redeemData = leverageManager.redeemV2(leverageToken, sharesToRedeem, minCollateral);
