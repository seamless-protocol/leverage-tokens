...
contract LeverageManagerBaseTest is FeeManagerBaseTest {
    ...
    function setUp() public virtual override {
        ...
        address leverageManagerProxy = UnsafeUpgrades.deployUUPSProxy(
            ...
            abi.encodeWithSelector(LeverageManager.initialize.selector, defaultAdmin, strategyTokenFactory)
        );
    ...
    function test_setUp() public view virtual override {
        ...
        assertEq(address(leverageManager.getStrategyTokenFactory()), address(strategyTokenFactory));
    }
