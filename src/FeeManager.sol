...
contract FeeManager is IFeeManager, Initializable, AccessControlUpgradeable, ReentrancyGuardUpgradeable {
    ...
    /// @param action Action to compute token action fee for, Mint or Withdraw
        ...
        returns (uint256, uint256)
    {
        ...
        // withdrawals by subtracting the token fee from the equity on mints and adding the token fee to the equity on
        // withdrawals.
