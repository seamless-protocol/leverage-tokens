...
interface ILendingAdapter {
    ...
    /// @notice Returns total debt of the position held by the lending adapter denominated in collateral asset
    /// @return debt Total debt of the position held by the lending adapter denominated in collateral asset
    function getDebtInCollateralAsset() external view returns (uint256 debt);
